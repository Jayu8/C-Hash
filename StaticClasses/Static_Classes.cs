...
* Program: Static Classes
* Description: A C# program to implement static classes
****************************************************************/
 ...
 * Description: Converts Tempearature scales
 * ***************************************************************/
...
/******************************************************************
 * Class name: TestTemperatureConverter
 * Methods   : Main
 * Description: Tests the converted Tempearature scales
 * ***************************************************************/
